...
public class semaforo2
{
    public static void main(String[] args)
    {
        ...
        semaforoVermelho = new Semaphore(numeroPermissoes, true);
       ...
       // semaforoVerde = new Semaphore(numeroPermissoes);
        ...
        Cor thread_vermelha = new Cor("Vermelho", iteracoes, semaforoVermelho);
        thread_vermelha.start();
        Cor thread_amarela = new Cor("Amarelo", iteracoes, semaforoVermelho);
        thread_amarela.start();
        Cor thread_verde = new Cor("Verde", iteracoes, semaforoVermelho);
        thread_verde.start();
    ...
    public static class Cor extends Thread 
    {
        ...
        public Cor(String cor, int iteracoes, Semaphore aguarda)
        {
